...
class CurrencyTableViewController: UITableViewController{
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        networking.getData(finalURL: "https://jsonplaceholder.typicode.com/users", completion: {
            () -> Void in
            let four = networking.pricelist[4]
            if let dictionary = four as? [String: Any] {
            ...
            //        networking.getJSON(finalURL: "https://jsonplaceholder.typicode.com/users")
...
//                            let price = self.networking.pricelist[indexPath.row]
//                            let priceText = price
